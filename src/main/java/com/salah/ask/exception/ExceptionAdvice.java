...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBadRequestException(EntityBadRequestException ex) {
        ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST,  "Bad request", ex.getLocalizedMessage());
        return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
    }
}
